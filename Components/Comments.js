        ...
        <div className="relative container p-1 appearance-none label-floating">
          <form>
            ...
            <div className="text-right">
              <button
                className="bg-orange-500 dark:bg-orange-600 text-white px-3 py-1.5 rounded text-sm font-semibold mr-5"
                onClick={(e) => {
                  e.preventDefault();
                  setComment("");
                }}
              ...
              <button
                className="bg-orange-500 dark:bg-orange-600 text-white px-3 py-1.5 rounded text-sm font-semibold"
                onClick={handelPost}
              >
                Post
              </button>
